...
function ListingPage3() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-white flex items-center justify-center gap-[10px] flex-col overflow-auto relative">
      <div
        className="w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-5 left-5 rounded-full flex items-center justify-center hover:bg-[red] transition"
      ...
      <div className="w-[95%] flex items-start justify-start text-[25px] md:w-[80%] mb-[10px]">
        <h1 className="text-[20px] text-[#272727] md:text-[30px] text-ellipsis text-nowrap overflow-hidden px-[70px] md:px-[0px]">
          {`In ${landmark?.toUpperCase() || "UNKNOWN"}, ${
      ...
      <div className="w-[95%] h-[400px] flex items-center justify-center flex-col md:w-[80%] md:flex-row">
        <div className="w-full h-[65%] md:w-[70%] md:h-full overflow-hidden flex items-center justify-center border-[2px] border-white">
          {frontEndImage1 && (
            <img
              src={frontEndImage1}
              alt="Preview 1"
