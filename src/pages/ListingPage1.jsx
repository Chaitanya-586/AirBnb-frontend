...
function ListingPage1() {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto">
      <form
        action=""
        className="max-w-[900px] w-[90%] h-[550px] flex items-center justify-start flex-col md:items-start gap-[10px] 
        overflow-auto mt-[50px]"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        {/* Back button */}
        <div
          className="w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-[5%] left-[20px] rounded-[50%] flex 
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px]">
          ...
          <input
            ...
            value={title}
            placeholder="___ BHK house or best title "
          />
        </div>
